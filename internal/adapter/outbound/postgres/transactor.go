...
// serializableRetry backs RunInTxWithRetry: SERIALIZABLE isolation with bounded
// exponential backoff on 40001/40P01 (handled inside pgcommon.RunInTxWithRetryOpts).
