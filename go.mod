...
// Direct dependencies
require (
	github.com/BCBP-SOLUTIONS-FZC-LLC/platform-events v1.0.0
	github.com/BCBP-SOLUTIONS-FZC-LLC/platform-gincommon v1.0.0
...
require (
	github.com/BCBP-SOLUTIONS-FZC-LLC/platform-pgcommon v1.0.0
