...
func buildEnvelope[T any](ctx context.Context, codec port.GlueCodec, eventType, tenantID, subject, actor string, payload T) (events.Envelope[json.RawMessage], error) {
